...
// from D:\Work\daScript\Modules\dasQuirrel\libquirrel\include\squirrel.h:260:23
	addExtern< SQRESULT (*)(SQVM *,SQInteger) , sq_bindenv >(*this,lib,"sq_bindenv",SideEffects::worstDefault,"sq_bindenv")
		->args({"v","idx"});
// from D:\Work\daScript\Modules\dasQuirrel\libquirrel\include\squirrel.h:261:23
	addExtern< SQRESULT (*)(SQVM *,SQInteger) , sq_setclosureroot >(*this,lib,"sq_setclosureroot",SideEffects::worstDefault,"sq_setclosureroot")
		->args({"v","idx"});
// from D:\Work\daScript\Modules\dasQuirrel\libquirrel\include\squirrel.h:262:23
	addExtern< SQRESULT (*)(SQVM *,SQInteger) , sq_getclosureroot >(*this,lib,"sq_getclosureroot",SideEffects::worstDefault,"sq_getclosureroot")
		->args({"v","idx"});
