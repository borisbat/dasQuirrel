...
// from D:\Work\daScript\Modules\dasQuirrel\libquirrel\include\squirrel.h:322:23
	addExtern< SQRESULT (*)(SQVM *,SQInteger,SQBool) , sq_newmember >(*this,lib,"sq_newmember",SideEffects::worstDefault,"sq_newmember")
		->args({"v","idx","bstatic"});
// from D:\Work\daScript\Modules\dasQuirrel\libquirrel\include\squirrel.h:323:23
	addExtern< SQRESULT (*)(SQVM *,SQInteger,SQBool) , sq_rawnewmember >(*this,lib,"sq_rawnewmember",SideEffects::worstDefault,"sq_rawnewmember")
		->args({"v","idx","bstatic"});
